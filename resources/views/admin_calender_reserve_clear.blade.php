...
@section('content')
  ...
  <section id="hero_contact" class="d-flex align-items-center">
    <div class="container text-center">
      <h1 class="mt-7 pt-5">管理者用予約解除画面</h1>
    </div>
  </section><!-- End Hero -->
        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 mx-auto">
            <div class="text-center mt-5">
              <form method="post" action="{{url('/admin_reserve_destroy')}}">
                @csrf
	              <div>
                ...
                @enderror
                <input id="date" type="date" name="date" class="form-control @error('date') is-invalid @enderror" min="{{date('Y-m-d')}}" max="">
                <button type="submit" class="btn btn-danger mt-5">予約を取り消す</button>
              </form>
            </div>
          </div>
        </div>
