        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 mx-auto">
            ...
            <div class="text-center">
              <h5 class="bold mt-5">
                <p class="text-red">キャンセル処理が確定をした際にレンティア運営からメールさせて頂きます。</p>
              </h5>
            </div>
            <form action="/customercancel_done_stay" enctype="multipart/form-data" method="POST">
              @csrf
              <input type="hidden" name="reservation_num" value="{{$reserve_num}}">
              <input type="hidden" name="state" value="stay">
              <div class="text-center">
