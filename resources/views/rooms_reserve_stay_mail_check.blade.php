        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 mx-auto">
            <div class="text-center mt-5">
              <h2>部屋を宿泊予約する際に、入力フォームに確認メールを送信してください</h2>
            </div>
            <form action="/stay_mail_check" method="POST" enctype="multipart/form-data" name="form1">
              @csrf
              <table class="mt-4">
                <tr>
                  <th><h2>Email</h2></th>
              ...
              <h2>メール送信失敗しました。<br>もう一度送るか、メールアドレスを変えて送信してください。</h2>
              </div>
              @endif
              @endif
              <div class="text-center mt-5">
