        ...
        <div class="row">
          <div class="col-lg-8 col-md-8 mx-auto">
            ...
            <form action="">
              ...
              <input type="text" readonly class="full_width mt-2 mt-2 @error('date') is-invalid @enderror" id="date" name="date" value="test">
              <table class="mt-4">
                <tr>
                  <th><h2>レンタル開始時間</h2></th>
                  @error('start_time')
                  <th><h5 class="error_text">{{$message}}</h5></th>  
                  @enderror
                </tr>
              </table>
              <input type="text" readonly class="full_width mt-2 mt-2 @error('start_time') is-invalid @enderror" id="start_time" name="start_time" value="test">
              <table class="mt-4">
                <tr>
                  <th><h2>レンタル終了時間</h2></th>
                  @error('end_time')
                  <th><h5 class="error_text">{{$message}}</h5></th>  
                  @enderror
                </tr>
              </table>
              <input type="text" readonly class="full_width mt-2 mt-2 @error('end_time') is-invalid @enderror" id="end_time" name="end_time" value="test">
              <div class="text-center mt-5">
