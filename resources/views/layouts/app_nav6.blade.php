...
<nav id="navbar" class="navbar order-last order-lg-0">
  ...
  <ul class="header__menu-list">
    ...
    <li class="header__menu-item header__menu-item--background"><a class="nav-link scrollto active" href="{{url('/contact')}}"><img src="{{asset('assets/img/header_icon_mail.svg')}}" alt="mail">お問い合わせ</a></li>
  </ul>
