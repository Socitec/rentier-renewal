...
@section('content')
  ...
  <?php
  $top = \DB::table('top_slider')->get();
  ?>
    <!-- slide -->
    <div class="sliderArea mt-5">
      <div class="slide01 slider">
        @foreach($top as $t)
        <div><img src="{{$t->image_pass}}" alt="slide"></div>
        @endforeach
      </div>
    </div>
      ...
      <div class="container">
        <div class="row col-md-9 col-lg-9 mx-auto">
          ...
          <div class="text-center mt-5">
            <a class="btn btn-primary text-white rounded-pill bold wide60" href="{{url('how_to_reserve')}}">予約の流れについて</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div class="container">
        <div class="row col-lg-9 col-md-9 mx-auto">
          ...
          <div class="col-md-4 col-lg-4">
            <div class="align-items-center">
              <img class="size" src="{{asset('assets/img/index_room.png')}}" alt="room">
            </div>
            <p class="bold">博多駅徒歩10分 4人までOK キャナルシティ・天神も…</p>
          </div>
          <div class="col-md-4 col-lg-4">
            <div class="align-items-center">
              <img class="size" src="{{asset('assets/img/index_room.png')}}" alt="room">
          ...
          <div class="text-center mt-5">
            <a class="btn btn-primary text-white rounded-pill bold wide90" href="{{route('rooms.index')}}">部屋一覧へ</a>
          </div>
        </div>
      </div>
    </section>
